const myQuestions = [
  ...
  {
    title: "Qual é o nome do vencedor do BBB 2022?",
    options: [
  ...
  {
    title: "Qual é o nome do mendigo que ficou famoso?",
    options: [
      { answer: "Givaldo", isCorrect: true },
      { answer: "Ronaldo", isCorrect: false },
      { answer: "Arnaldo", isCorrect: false },
      { answer: "Geraldo", isCorrect: false },
    ],
  },
  {
